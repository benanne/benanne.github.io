...
Ferenc points out an interesting implication: **high-dimensional Gaussians are very similar to uniform distributions on the sphere**. This clearly isn't true for the one-dimensional case, but it turns out that's an exception, not the rule. Stefan Stein also discusses this implication in more detail in [a recent blog post](https://web.archive.org/web/20201031103701/https://stefan-stein.github.io/posts/2020-03-07-concentration-properties-of-high-dimensional-normal-distributions/).
