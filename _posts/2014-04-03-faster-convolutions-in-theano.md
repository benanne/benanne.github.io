...
<!-- TODO: use the LenetConvPoolLayer from the tutorial as an example, replace it there -->
...
<!-- The performance advantage is significant, especially considering that the batch size is not a multiple of 512, the network is relatively small, and we're dimshuffling all over the place. -->



<!-- 
  in summary, the flexibility of Theano + speed of cuda-convnet is a very powerful combination (cfr. Galaxy Zoo)

  the future: an ICLR paper from LeCun's lab suggests using FFTs to compute convolutions. Would be great to see this in Theano someday!
  http://openreview.net/document/aa6ab717-ca19-47e1-a958-823b9a106ca9#aa6ab717-ca19-47e1-a958-823b9a106ca9
 -->
...
The code for file convolutional_mlp.py ran for 221.72m
