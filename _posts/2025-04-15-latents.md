...
* The combination of a **regression loss**, a **perceptual loss** and an **adversarial loss** is surprisingly persistent. Almost all modern implementations of autoencoders for latent representation learning are variations on this theme.
